...
Most agents support OAuth connectors. To connect, add the server URL as a remote MCP 
server and sign in with your IBMid when your agent prompts you. For clients that use a 
mcp.json config file, the minimal setup is:
...
For clients that don't support OAuth discovery, use an auth token and session ID instead. Carbon MCP
still supports that method for anyone already set up that way.
...
- Sign in with your IBMid when Cursor prompts you
...
For best results with Carbon MCP, install the Carbon Builder skill. The source is in 
this [Github repo](https://github.com/carbon-design-system/carbon-mcp/tree/main/public/skills/carbon-builder).
This skill gives AI agents the Carbon-specific context they need to follow Carbon
...
- Download the
  [carbon-builder skill](https://github.com/carbon-design-system/carbon-mcp/raw/main/public/skills/carbon-builder.zip) and
  unzip it.
...
Download the
[carbon-builder skill](https://github.com/carbon-design-system/carbon-mcp/raw/main/public/skills/carbon-builder.zip). No need
